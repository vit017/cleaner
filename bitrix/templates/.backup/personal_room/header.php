...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/layout/mcstyle/css/star-rating.min.css" charset="utf-8">
    ...
    <script type="text/javascript" src="/layout/mcstyle/js/star-rating.min.js"></script>
    <script type="text/javascript" src="/layout/mcstyle/js/flipclock.min.js"></script>
    <!--[if gte IE 9]>
