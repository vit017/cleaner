...
<head>
    ...
    <link rel="icon" href="img/favicon.ico" type="image/x-icon"> <!--Подключаем favicon для IE-->
    <link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon"> <!--Подключаем favicon для остальных-->
    ...
    <!---->
    <!--ПОДКЛЮЧАЕМ СКРИПТЫ-->
    <script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script><!--Подключаем последнюю JQuery библиотеку-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-4 col-sm-9 col-xs-7">
                    <b class="visible-sm visible-xs text-center"><a href="tel:88000000000">8 800 000-00-00</a></b>
                    <div class="select_cont">
                        <i class="icon locate"></i>
                        <select class="selectpicker" id="town">
                ...
                <div class="col-lg-5 col-md-6 hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        <li><i class="icon phone"></i><b><a href="tel:88000000000">8 800 000-00-00</a></b></li>
                        <li class="enter">

                                <? global $USER;
                                if ($USER->IsAuthorized()) {?>
                                <button type="button" onclick="location.href='?logout=yes';">
    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="floating">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-4 col-sm-9 col-xs-7">
                    <!-- <button type="button" class="btn btn-default" id="get_clean">Оформить заказ</button> -->
                </div>
                <div class="col-lg-5 col-md-6 hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        <li><i class="icon phone"></i><b><a href="tel:88000000000">8 800 000-00-00</a></b></li>
                        <li class="enter"><button type="button"><i class="icon log_in"></i>Войти</button></li>
                        <li><button type="button" data-toggle="modal" data-target="#menu"><i class="icon menu"></i><span>Меню</span></button></li>
                    </ul>
                </div>
                <div class="col-xs-1 col-sm-1 visible-sm visible-xs">
