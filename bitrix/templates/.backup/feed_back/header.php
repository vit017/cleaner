...
<head>
    ...
    <title>MAXclean :: <?$APPLICATION->ShowTitle()?></title>
    ...
    <link rel="stylesheet" type="text/css" href="<?=SITE_TEMPLATE_PATH?>/css/manual.css" charset="utf-8" /> <!--Подключаем основные редактируемые стили-->
        ...
        <nav class="navbar navbar-default navbar-fixed-top" id="floating">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 hidden-sm hidden-xs">
                        <ul class="nav navbar-nav">
                            <li><i class="icon phone"></i><b>8 800 000-00-00</b></li>
                            <?if(!$USER->isAuthorized()){?>
                                <li class="enter"><span><i class="icon log_in"></i><a href="/user/?backurl=<?=$APPLICATION->GetCurPage()?>">Войти</a></span></li>
                            <?}else{?>
                                <li class="enter"><span><i class="icon log_in"></i><a href="/user/">Профиль</a></span></li>
