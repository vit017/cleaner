...
<tr>
	...
	<td width="60%"><?=CBPDocument::ShowParameterField("text", 'review_users', $arCurrentValues['review_users'], Array('rows'=>'2'))?></td>
</tr>
<tr>
...
<tr>
	<td align="right"><?= GetMessage("BPAR_PD_STATUS_MESSAGE") ?>:<br/><?= GetMessage("BPAR_PD_STATUS_MESSAGE_HINT") ?></td>
...
<tr>
	...
	<td>
		<input type="text" name="timeout_duration" id="id_timeout_duration" value="<?= htmlspecialchars($arCurrentValues["timeout_duration"]) ?>" size="20" />
