...
{
	?>
	var valueTd = document.getElementById('td_<?= htmlspecialchars($fieldKey) ?>');
	valueTd.innerHTML = objFieldsCD.GetGUIFieldEdit('<?= htmlspecialchars($fieldKey) ?>', '<?= CUtil::JSEscape($arCurrentValues[$fieldKey]) ?>', true);
	<?
}
?>
</script>