...
function BPRIAAddParam(vId, vName, vTitle, vType, vOptions, vDefault, vRequired, vMultiple)
{
	...
	var newCell = newRow.insertCell(-1);
	newCell.align="right";
	newCell.innerHTML = '<a href="#" onclick="BPRIAParamEditParam(' + vId + '); return false;"><?= GetMessage("BPSFA_PD_CHANGE") ?></a>&nbsp;|&nbsp;<a href="#" onclick="BPRIADeleteRow(' + vId + '); return false;"><?= GetMessage("BPSFA_PD_DELETE") ?></a>';
}
