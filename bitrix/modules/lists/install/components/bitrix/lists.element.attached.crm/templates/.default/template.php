		...
		<div class="leac-grid-container">
			...
			$APPLICATION->IncludeComponent(
				...
				array(
					...
					'TOTAL_ROWS_COUNT' => $arResult['GRID_NAVIGATION'][$iblockId]['TOTAL_ROWS_COUNT'],
					'AJAX_MODE' => 'Y',
					'AJAX_ID' => CAjax::getComponentID('bitrix:main.ui.grid', '.default', ''),
					'ENABLE_NEXT_PAGE' => $arResult['GRID_NAVIGATION'][$iblockId]['ENABLE_NEXT_PAGE'],
					'PAGE_SIZES' => $arResult['GRID_NAVIGATION'][$iblockId]['PAGE_SIZES'],
