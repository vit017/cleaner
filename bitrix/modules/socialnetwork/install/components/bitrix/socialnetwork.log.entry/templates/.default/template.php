			...
			?>"><?
				...
				?><div class="feed-post-informers"><?
					...
					?><span class="feed-post-time-wrap"><?
						...
						$datetime_detail = CSocNetLogComponent::getDateTimeFormatted($timestamp, array(
