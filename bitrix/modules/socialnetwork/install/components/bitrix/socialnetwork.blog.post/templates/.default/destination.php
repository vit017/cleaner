...
<div class="feed-add-post-destination-block feed-add-post-destination-block-post" id="destination-sharing" style="display:none;">
	...
	<div class="feed-add-post-buttons-post">
		<a id="sharePostSubmitButton" class="feed-add-button" href="javascript:void(0)" onclick="sharingPost()"><?=GetMessage("BLOG_SHARE_ADD")?></a>
		<a class="feed-cancel-com" href="javascript:void(0)" onclick="closeSharing();"><?=GetMessage("BLOG_SHARE_CANCEL")?></a>
	</div>
	</form>
</div>
